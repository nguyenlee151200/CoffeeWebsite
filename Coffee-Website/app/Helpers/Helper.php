    ...
    foreach ($data as $val) {
        ...
        if ($val['parent_id'] == $parent_id) {
            ...
            echo '<td class="list_td aligncenter">
		            <a class="btn btn-xs btn-info" href="../admins/cates/edit/' . $id . '" title="Sửa"><span class="fa fa-edit"> Sửa</span></a>&nbsp;&nbsp;&nbsp;
		            <a class="btn btn-xs btn-danger" href="../admins/cates/del/' . $id . '" title="Xóa" onclick="return confirm(\'Bạn chắc chắn muốn xóa danh mục này ?\') "> <span class="fa fa-trash"> Xóa</span> </a>
			      </td>
			    </tr>';
